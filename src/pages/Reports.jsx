              ...
              {filteredReservations.map(res => {
                ...
                return (
                  <tr key={res.id}>
                    ...
                    <td style={{ padding: '10px', borderBottom: '1px solid #eee', color: '#444' }}>{formatSafeDate(res.startDate, 'dd-MM-yyyy')}</td>
                    <td style={{ padding: '10px', borderBottom: '1px solid #eee', color: '#444' }}>{formatSafeDate(res.endDate, 'dd-MM-yyyy')}</td>
                    <td style={{ padding: '10px', borderBottom: '1px solid #eee', color: '#444' }}>{res.flightIn || '-'}</td>
                    <td style={{ padding: '10px', borderBottom: '1px solid #eee', color: '#444' }}>{res.flightOut || '-'}</td>
